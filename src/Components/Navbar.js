...
const Navbar =(props)=> {
        return (
            ...
            style={{  backgroundImage: props.mode === 'dark' ? 'linear-gradient(to top left, #1f2937, #1f2937)' : 'linear-gradient(to bottom right, #c28888, #ebc2c2)' }}>
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div className="form-check form-switch">
                            ...
                            <label className="form-check-label" htmlFor="flexSwitchCheckChecked" style={{ color: props.mode === 'dark' ? 'rgba(255,255,255,0.55)' : 'rgba(0,0,0,0.65)' }}>Dark mode</label>
                        </div>
                    </div>
                </div>
            </nav>
